...
public class BookInfo extends Fragment {
    ...
    private View view;
    private String title = "", author = "", date = "", picturePath = "";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TextView titleView = view.findViewById(R.id.info_title);
        final TextView authorView = view.findViewById(R.id.info_author);
        final TextView dateView = view.findViewById(R.id.info_date);
        ...
        if(picturePath.isEmpty()){
            imageView.setImageResource(R.drawable.blobpolice);
        }
        else{
